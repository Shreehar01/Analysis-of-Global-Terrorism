...
year and then plot an interactive line plot that shows the trend of the occurrence. There will
...
on x-axis and the number of people killed on y-axis. Each of the dots in the plot will represent a country.
The dots for America and a few other countries with interesting insights will highlighted with different colors and
...
the highest number of people killed in the aforementioned timeframe. The plot will have 10 lines, representing the terrorist groups
