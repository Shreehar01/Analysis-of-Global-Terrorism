...
## Contents {background-image="./background.jpg"}
<hr>
- Introduction
- Datasets
- Progress
...
- Questions: Region, Country, Group, Method, Target, etc of terrorist attacks
- Effects of terrorism on GDP, Migration and Fertility Rate

## Datasets {background-image="./background.jpg"}
::: {.panel-tabset}
...
## Progress {background-image="./background.jpg"}
<hr>
...
fig.update_layout(title_x=0.425)
fig.show()
```
...
## Setbacks {background-image="./background.jpg"}
<hr>
- Reading Files
...
## Future Work {background-image="./background.jpg"}
<hr>
...
<h1 style="position: absolute; top: 50%; transform: translate(0, -50%); padding: 10px; left: 27%;">
Feedbacks?
<h2>