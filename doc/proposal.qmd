...
To answer this, I will first, create five distinct distinct dataframes that consists of rows representing 
...
were killed from each of the countries and then plot a scatter plot bar plot displaying the number of terrorist attacks
on x-axis and number of people killed on y-axis. Each of the dots in the plot will represent a country.
The dots for America and few other countries with interesting insights will highlighted with different colors and
...
terrorist attacks for each year in a country. On the same line plot, another line indicating percentage change in the GDP per capita 
...
the minimum value of median global percentage change in GDP and the number of terrorist attacks as 0 and their maximum value 
...
percentage change in number of migrants and the number of terrorist attacks as 0 and their maximum value as 1. Lastly, each of the 
...
terrorist-prone countries will give us a general indication of the existence of the relationship between net number of migrants and the number of terrorist attacks.
...
different colors and to make sure that the lines are not of irregular scale (which is highly likely as percentage change in fertility rate and 
